...
public abstract class FloatKDTree<T> {
    ...
    private FloatKDTree(int dimensions) {
    ...
    public static class Euclidean<T> extends FloatKDTree<T> {
    ...
    public static class Manhattan<T> extends FloatKDTree<T> {
    ...
    public static class WeightedManhattan<T> extends FloatKDTree<T> {
